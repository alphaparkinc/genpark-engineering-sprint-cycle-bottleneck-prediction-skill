# genpark-engineering-sprint-cycle-bottleneck-prediction-skill
...
> **GenPark AI Agent Skill** -- Engineering sprint cycle bottleneck & PR review predictor (Linear style)
